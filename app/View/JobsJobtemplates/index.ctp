<div class="jobsJobtemplates index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Jobs Jobtemplates'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Jobs Jobtemplate'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($jobsJobtemplates as $jobsJobtemplate): ?>
					<tr>
								<td>
			...
			<?php echo $this->Html->link($jobsJobtemplate['Jobtemplate']['id'], array('controller' => 'jobtemplates', 'action' => 'view', $jobsJobtemplate['Jobtemplate']['id'])); ?>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $jobsJobtemplate['JobsJobtemplate']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $jobsJobtemplate['JobsJobtemplate']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $jobsJobtemplate['JobsJobtemplate']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $jobsJobtemplate['JobsJobtemplate']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
