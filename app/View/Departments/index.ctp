					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Department'), array('action' => 'add'), array('escape' => false)); ?></li>
				...
				<?php foreach ($departments as $department): ?>
					<tr>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $department['Department']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $department['Department']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
